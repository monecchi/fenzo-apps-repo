...
import { Receipt, Wrench, CurrencyDollarSimple } from 'phosphor-react'
import FooterFull from '../../components/Footer/FooterFull'


const visitReason = [
  {
    label: 'Defeito na Pintura',
    name: 'defeito-na-pintura'
  },
  {
    label: 'Defeito mecânico',
    name: 'defeito-mecanico'
  },
  {
    label: 'Defeito elétrico',
    name: 'defeito-eletrico'
  }
]
...
const VisitaTecnica = () => {
  ...
  return (
    <>
      <Head>
        <title>Fenzo Serralheria - Visita Técnica</title>
      </Head>
      <BaseLayout>
        <Section bg="#EFF2F5" className="page_header__section" full={true} direction="column">
          <PageHeaderDefault
            ...
            justify="center"
          >
            <Wrench size={48} color="blue" weight="duotone" style={{ marginBottom: "1rem", alignSelf: "center" }} />
            <Heading
              as="h1"
            ...
            <Heading as="span" d="block" fontSize="1rem" textTransform="uppercase" letterSpacing="0" color="brand.blue" mt="1rem">Agendar Visita Técnica</Heading>
          </PageHeaderDefault>
        </Section>
