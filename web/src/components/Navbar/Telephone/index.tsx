...
const NavbarTelephone: React.FC<ITelephone> = (props) => {
  ...
  return(
    <TelephoneComponent>
      <a className="btn btn--link btn--size-l btn--iconize responsive-header__button h-auto" role="link" aria-label="Ligar" href={'tel://'+phoneNumber}>
        <span className="icon-fenzo icon-fenzo--telephone btn__icon">
          {/*<Icon color="currentColor" size={24} icon="phone-call" />*/}
          <svg version="1.1" id="phone" className="fenzo-phone-icon animated" fill="currentColor" xmlns="https://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 82 82" width="23" height="23px">
